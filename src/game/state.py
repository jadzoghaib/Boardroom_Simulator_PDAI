...
class GameState(BaseModel):
    ...
    def summary_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "sector": self.sector,
            "celebrity": {"name": self.celebrity.get("name", ""), "domain": self.celebrity.get("domain", ""), "avatar_url": self.celebrity.get("avatar_url", "")},
            "professor": {"name": self.professor.get("name", ""), "domain": self.professor.get("domain", ""), "avatar_url": self.professor.get("avatar_url", "")},
